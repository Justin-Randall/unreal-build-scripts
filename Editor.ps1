...
Invoke-EditorBuild -Configuration $Configuration -UnrealEngineDir $UnrealEngineDir -ProjectDir $proj.ProjectDir -ProjectName $proj.ProjectName -ProjectPath $proj.ProjectPath -StartDir $scriptDir
